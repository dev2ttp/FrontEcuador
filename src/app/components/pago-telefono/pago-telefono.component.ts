...
import { VueltoTelefono } from '../../models/pago/vueltoTelefono';
...
@Component({
  selector: 'app-pago-telefono', 
  templateUrl: './pago-telefono.component.html',
  styleUrls: ['./pago-telefono.component.css']  
})

export class PagoTelefonoComponent  implements OnInit, OnDestroy {
  ...
  ngOnInit() {
    this.pago.montoAPagar = localStorage.getItem("monto");
    console.log("montooo:"+this.pago.montoAPagar)
    this.estadoDinero()
  }
  async estadoDinero() {
    try {
